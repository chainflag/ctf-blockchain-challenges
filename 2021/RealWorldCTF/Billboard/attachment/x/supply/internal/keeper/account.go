...
import (
	...
	"github.com/iczc/billboard/x/supply/internal/types"
)
...
func (k Keeper) SetModuleAddressAndPermissions(maccPerms map[string][]string) {
	for name, perms := range maccPerms {
		k.permAddrs[name] = types.NewPermissionsForAddress(name, perms)
	}
}
